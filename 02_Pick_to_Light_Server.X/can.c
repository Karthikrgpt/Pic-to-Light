...
void init_can(void)
{
    ...
    /* Enter CAN module into one board to another mode */
...
void can_transmit(void)
{
	...
	TXB0D0 = can_data[0];			/* DataByte 0 */
	TXB0D1 = can_data[1];			/* DataByte 1 */
	TXB0D2 = can_data[2];			/* DataByte 2 */
	TXB0D3 = can_data[3];			/* DataByte 3 */
	TXB0D4 = can_data[4];			/* DataByte 4 */
	TXB0D5 = can_data[5];			/* DataByte 5 */
	TXB0D6 = can_data[6];			/* DataByte 6 */
	TXB0D7 = can_data[7];			/* DataByte 7 */

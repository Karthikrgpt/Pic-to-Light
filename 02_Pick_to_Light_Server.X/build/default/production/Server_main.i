...
void data_recived_from_client(unsigned char can_payload[13]) {
    ...
    product_id[0] = can_payload[5] + '0';
    product_id[1] = can_payload[6] + '0';
    product_id[2] = can_payload[7] + '0';
    product_id[3] = can_payload[8] + '0';
    unit_stock[0] = can_payload[9] + '0';
    unit_stock[1] = can_payload[10] + '0';
    unit_stock[2] = can_payload[11] + '0';
    unit_stock[3] = can_payload[12] + '0';
